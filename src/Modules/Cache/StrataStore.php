...
class StrataStore extends TaggableStore implements SafeLockProvider
{
    ...
    // Laravel only exposes this as a Repository constant from v13 onward.
    // The prefix itself is stable across the versions we support, so we keep our own copy here.
    public const string FLEXIBLE_CREATED_KEY_PREFIX = 'illuminate:cache:flexible:created:';
    ...
    {
        $path = $this->getFilepath(self::FLEXIBLE_CREATED_KEY_PREFIX.$key);
